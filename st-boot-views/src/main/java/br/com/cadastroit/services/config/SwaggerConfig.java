...
public class SwaggerConfig extends WebMvcConfigurationSupport{
	...
	public Docket databaseAPI() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("br.com.cadastroit.services.controller"))
...
//	            .securityContexts(Lists.newArrayList(securityContext()))
	...
	private ApiInfo metaData() {
		return new ApiInfoBuilder()
				  .title("CST BOOT VIEWS - API to GET VALUES FROM COMPLIANCE VIEWS")
				  .description("\"Compliance Fiscal CST BOOT VIEWS\"")
				  .version("1.0.0")
				  .license("Apache License 2.0.0")
				  .licenseUrl("https://www.apache.org/licenses/LICENSE-2.0\"")
				  .contact(new Contact("Compliance Solucoes Fiscais", "https://compliancefiscal.com.br", "contato@compliancefiscal.com.br"))
				  .build();
	}
