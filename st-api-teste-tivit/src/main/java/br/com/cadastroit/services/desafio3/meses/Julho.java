...
public class Julho extends AbstractDataValues {
	...
	public Map<String, List<Double>> valuesPerDay() {
		...
		return Map.ofEntries(
				Map.entry("01", generateValues(4 + random.nextInt(7))),
				Map.entry("02", generateValues(4 + random.nextInt(7))),
				Map.entry("03", generateValues(4 + random.nextInt(7))),
				Map.entry("04", generateValues(4 + random.nextInt(7))),
				Map.entry("05", generateValues(4 + random.nextInt(7))),
				Map.entry("06", generateValues(4 + random.nextInt(7))),
				Map.entry("07", generateValues(4 + random.nextInt(7))),
				Map.entry("08", generateValues(4 + random.nextInt(7))),
				Map.entry("09", generateValues(4 + random.nextInt(7))),
				Map.entry("10", generateValues(4 + random.nextInt(7))),
				Map.entry("11", generateValues(4 + random.nextInt(7))),
				Map.entry("12", generateValues(4 + random.nextInt(7))),
