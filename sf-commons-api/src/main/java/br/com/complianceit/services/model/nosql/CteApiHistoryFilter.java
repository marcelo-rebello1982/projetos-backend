...
@Document(value="cteapi-history-filter")
public class CteApiHistoryFilter implements Serializable{
	
	private static final long serialVersionUID = -1442819393382647111L;
	private Long id;
