...
import br.com.cadastroit.services.api.domain.NotaFiscal;
...
public class NfServCommonsController {
	...
	protected final  ConstrNfsMapper constrNfsMapper = Mappers.getMapper(ConstrNfsMapper.class);
...
//    @Builder.Default
//    private final Function<Long, String> toStr = String::valueOf;
//    @Builder.Default
//    private final Function<Integer, String> toInt = String::valueOf;
//    @Builder.Default
//    private final Function<AtomicLong, String> toLong = AtomicLong::toString;
//    @Builder.Default
//    private final Function<String, Integer> strToInt = x -> Integer.valueOf(x);
//    @Builder.Default
//    private Long qtdProcessAux = 0L;
//    @Builder.Default
//    private Long qtdPendenciaAux = 0L;
//    @Builder.Default
//    private Long qtdAutorizadaAux = 0L;
//    @Builder.Default
//    private Long qtdCanceladaAux = 0L;
    ...
    private String[] castObjectToArray(NfServDto nfServDto) {
        String[] array = new String[10];
        array[0] = nfServDto.getId() == null ? null : Long.toString(nfServDto.getId());
        array[1] = String.valueOf(nfServDto.getDmStProc());
        return array;
    }
